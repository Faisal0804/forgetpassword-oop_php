...
{
  $email = $_POST['email'];
  $check_email = "select email from tbl_student where email='$email'";
  ...
  if($res != false)
  {
    ...
    $message = '<div>
     ...
     <br>
     <p><button class="btn btn-primary"><a href="http://localhost/reset-password/passwordreset.php?secret='.base64_encode($email).'">Reset Password</a></button></p>
     <br>
...
$mail->Port = 587; 
$mail->Username = "faisal.lu.ac@gmail.com";
$mail->Password = "ixwqurlowvsmdyuh";
